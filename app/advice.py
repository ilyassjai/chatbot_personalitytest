...
cohere_api_key = "p1KhsnQvwP0XVSfUGLnYgxBwRzXMPjQdQx31mrh1"
...
import json
with open('C:\\Users\\ilyas\\Desktop\\ScoringCorrelation\\app\\description.json') as f:
    items = json.load(f)
...
def get_advice(scores : List[Tuple[str, Percentage]]):
    ...
    prompt = PromptTemplate(
        template="""
    Give advice based on the personality traits of the user and suggest activities or actions they could take to better their mental health, which are determined by the following scores :
...
def save_img(i,personality_scores):
    ...
    plt.savefig(f'C:\\Users\\ilyas\\Desktop\\ScoringCorrelation\\imgs\\img{i}.png')

if __name__ == "__main__":
    i=0
    chunks = [
    "I don't really feel like doing anything these days, not even the things I used to enjoy.",
    "Yes, over the past few months, I've felt really down and stressed more days than not. It's hard to shake off the sadness.",
    "I haven't been feeling confident about my abilities at all recently. Everything seems more challenging than it used to be.",
    "I have dreams, but lately, they seem far away and unrealistic. I've been feeling pretty hopeless about achieving them.",
    "I feel somewhat isolated. I know my family and friends are around, but I don't feel like they truly understand what I'm going through.",
    "I've been involved in a few projects, but I don't really feel any enjoyment from them anymore. It feels more like going through the motions.",
    "Yes, social situations make me anxious lately. I often feel uncomfortable and out of place around others."
]
    ...
    with open(f'output/advice{i}.md', 'a') as f:
        f.write(f'\n \n![alt text](C:\\Users\\ilyas\\Desktop\\ScoringCorrelation\\imgs\\img{i}.png)')